...
datasets = ['mit-states']#['ut-zappos']#, 'mit-states'] #, 'cgqa'
data_cap = ['ut', 'c', 'mit']
...
def subproc(dataset, seed, epoch):
    ...
    subprocess.run(["/users/pyu12/.conda/envs/gpu/bin/python3.8", "evaluate.py",
                    "--dataset", dataset,
                    "--experiment_name", f"coop",
                    "--clip_model", formal_models[1],
                    "--soft_embeddings", pt_file,
